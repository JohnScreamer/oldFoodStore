...
import { benefitsArr } from "../../Constants/benefitsSliderInfo";
import s from "./Benefits.module.scss";
const Benefits = () => {
    const [activeSlid, setActiveSlid] = useState("caribu");
    const active = benefitsArr.find((slide) => {
        if (slide.name === activeSlid) {
            return slide;
        }
    });

    const switchSlide = (name: string) => {
        setActiveSlid(name);
    };
    ...
    return (
        <div className={s.wrapper}>
            <div
                style={{
                    background: ` linear-gradient(90deg, #211F20 0%, rgba(68, 64, 63, 0) 100%),url(${active?.img}) center center/cover no-repeat `,
                }}
            ...
            >
                ...
                <div className={s.btn}>
                    <button onMouseOver={() => switchSlide("malibu")}>
                        <svg
                            width="70"
                            height="70"
                            viewBox="0 0 70 70"
                            fill={activeSlid === "malibu" ? "#79B282" : "white"}
                    ...
                    <button onMouseOver={() => switchSlide("oldDog")}>
                        <svg
                            width="60"
                            height="60"
                            viewBox="0 0 60 60"
                            fill={activeSlid === "oldDog" ? "#79B282" : "white"}
                            xmlns="http://www.w3.org/2000/svg"
                        >
                            <path
                        ...
                        <span>Старий пес</span>
                    </button>
                    <button onMouseOver={() => switchSlide("legend")}>
                        <svg
                            width="61"
                            height="61"
                            viewBox="0 0 61 61"
                            fill={activeSlid === "legend" ? "#79B282" : "white"}
                            xmlns="http://www.w3.org/2000/svg"
                        >
                    ...
                    <button onMouseOver={() => switchSlide("friday")}>
                        <svg
                            width="61"
                            height="61"
                            viewBox="0 0 61 61"
                            fill={activeSlid === "friday" ? "#79B282" : "white"}
                            xmlns="http://www.w3.org/2000/svg"
                        >
                            <g clipPath="url(#clip0_31_25)">
                                <path
